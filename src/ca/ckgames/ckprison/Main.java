...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        databaseHandler.setupTables(this, config.defaultRank);
        ...
        // Setup mines...
        mineHandler = new MineHandler(rankHandler);
        List<MineLoadingResult> mineLoadingResults = mineHandler.loadMines(this, config, configFile);
        ...
        Runnable resetMinesTask = () -> mineHandler.resetAllMines();
